...
echo "  python main.py"
echo ""
echo "Cloud deployment: https://focusflow-backend-962980262153.us-central1.run.app"
echo "Server will run locally at: http://localhost:8000"
echo "API docs (cloud): https://focusflow-backend-962980262153.us-central1.run.app/docs"
